...
with open('result_weightdecay/val_labels/val_label.pkl', 'wb') as f:
...
for j in range(1, 50):
    ...
    with open('result_weightdecay/labels/y_{0}.pkl'.format(j), 'wb') as f1:
        pickle.dump(y, f1)
    
    with open('result_weightdecay/yhats/yhat_{0}.pkl'.format(j), 'wb') as f2:
        pickle.dump(yhats, f2)

    with open('result_weightdecay/yhats_val/yhat_val_{0}.pkl'.format(j), 'wb') as f3:
        pickle.dump(yhats_val, f3)
    
    with open('result_weightdecay/uncertainty/epi_ale_{0}.pkl'.format(j), 'wb') as f4:
