...
with open('result_smooth/val_labels/val_label.pkl', 'wb') as f:
...
for j in range(50):
    ...
    with open('result_smooth/labels/y_{0}.pkl'.format(j), 'wb') as f1:
        pickle.dump(y, f1)
    
    with open('result_smooth/yhats/yhat_{0}.pkl'.format(j), 'wb') as f2:
        pickle.dump(yhats, f2)

    with open('result_smooth/yhats_val/yhat_val_{0}.pkl'.format(j), 'wb') as f3:
        pickle.dump(yhats_val, f3)
    
    with open('result_smooth/uncertainty/epi_ale_{0}.pkl'.format(j), 'wb') as f4:
